...
全チケットが特殊申込済みチケットに該当する場合は、1チケットイベントと同等の早期リターンを行う。この場合は各チケットが無料であることだけを確認し、期待チケット、プラン変更チケット、旧会員重複、オンラインURL、主催者お知らせの通常チェックは実施しない。
...
- `運営メンバー` チケットが存在すること
- `運営メンバー` チケットの金額が0円であること

`運営メンバー` チケットは通常の会員プラン照合、オンラインURLチェック、主催者お知らせチェックから除外する。
